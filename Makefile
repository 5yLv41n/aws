...
start-docker-localstack:
	...
	docker run -d -p 4566:4566 -p 4567:4566 -p 4568:4566 -p 4571:4566 -p 4572:4566 -p 4573:4566 -p 4574:4566 -p 4575:4566 -p 4576:4566 -e SERVICES=sts,cloudformation,logs,events,iam,sns,ssm,dynamodb,athena -v /var/run/docker.sock:/var/run/docker.sock --name async_aws_localstack localstack/localstack && \
